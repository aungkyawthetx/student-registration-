...
<div class="card shadow-sm">
    <div class="card-header bg-white border-bottom">
        <div class="container d-flex justify-content-between align-items-center mt-1">
            <h2 class="d-inline mb-0">Courses List</h2>
        ...
        <div class="container mt-2">
            <div class="row">
                <div class="col-md-6 col-lg-4 d-flex gap-2">
                    <form action="{{ route('courses.search') }}" method="GET" class="mb-2 w-100 input-group">
                        @csrf
                                ...
                                @if(auth()->user()->hasRole('Admin') || auth()->user()->hasRole('Super admin'))
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <form action="{{ route('courses.destroy', $course->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this row?')">
                                                @csrf
                                                @method('DELETE')
